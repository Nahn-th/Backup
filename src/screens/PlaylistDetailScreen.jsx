...
import { getSongsByPlaylist, removeSongFromPlaylist } from '../database/db';
...
const PlaylistDetailScreen = () => {
    ...
    const loadSongs = () => {
        const playlistSongs = getSongsByPlaylist(playlist.id);
                ...
                ListHeaderComponent={
                    <View style={styles.headerContent}>
                        {playlist.cover_image_path ? (
                            <Image
                                source={{ uri: playlist.cover_image_path }}
                            ...
                            >
                                <Icon name="folder" size={80} color={colors.iconInactive} />
                            </View>
                        )}
